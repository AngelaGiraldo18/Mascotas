...
public class PricipalMascotas {

	public static void main(String[] args) {
		HashMap<String, ProcesosMascotas> mapaMascotas = new HashMap<>();
        ArrayList<ProcesosMascotas> listaMascotas = new ArrayList<>();
        
        int n = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de mascotas "));
        for (int i = 0; i < n; i++) {
        	ProcesosMascotas mascota = new ProcesosMascotas();
            mascota.ingresar();
    ...
    public static void consultarMascota(HashMap<String, ProcesosMascotas> mapaMascotas) {
        String identificacion = JOptionPane.showInputDialog("Ingrese la identificación de la mascota:");
        ProcesosMascotas mascota = mapaMascotas.get(identificacion);
        if (mascota != null) {
    ...
    public static void consultarListaMascotas(ArrayList<ProcesosMascotas> listaMascotas) {
        StringBuilder lista = new StringBuilder();
        for (ProcesosMascotas mascota : listaMascotas) {
    ...
    public static void modificarMascota(HashMap<String, ProcesosMascotas> mapaMascotas) {
        ...
        if (mascota != null) {
            ...
            mascota.name(nuevoNombre, nuevoNombre, 0, nuevoNombre);
